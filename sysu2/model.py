...
def get_unet(img_shape=None, filter_size=None):
    # dim_ordering = 'tf'
...
def augment(x_0, x_1, y):
    ...
    x_0 = apply_affine_transform(x_0[..., np.newaxis], theta=theta, tx=0, ty=0, shear=shear, zx=zx, zy=zy, channel_axis=2)
    x_1 = apply_affine_transform(x_1[..., np.newaxis], theta=theta, tx=0, ty=0, shear=shear, zx=zx, zy=zy, channel_axis=2)
    y = apply_affine_transform(y[..., np.newaxis], theta=theta, tx=0, ty=0, shear=shear, zx=zx, zy=zy, channel_axis=2)
