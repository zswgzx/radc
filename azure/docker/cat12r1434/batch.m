matlabbatch{1}.spm.tools.cat.estwrite.data{1,1} = '/home/shengwei/work/software/devops/user_sz/pipelines/cat12r1434/standalone/190731_08_83216408-n4.nii';
matlabbatch{1}.spm.tools.cat.estwrite.data{2,1} = '/home/shengwei/work/software/devops/user_sz/pipelines/cat12r1434/standalone/190731_09_96768556-n4.nii';

matlabbatch{1}.spm.tools.cat.estwrite.nproc = 2;
matlabbatch{1}.spm.tools.cat.estwrite.opts.tpm = {[pwd '/TPM.nii']};
