# -*- coding: utf-8 -*-
#
# xnat documentation build configuration file, created by
...
project = 'XNAT'
copyright = '2011 -- 2019, Hakim Achterberg'
...
with xnat.connect(server='https://central.xnat.org', extension_types=False) as session:
    ...
    classes_module.__package__ = 'xnat'
    classes_module.__name__ = 'xnat.classes'
    xnat.classes = classes_module
    sys.modules['xnat.classes'] = classes_module
